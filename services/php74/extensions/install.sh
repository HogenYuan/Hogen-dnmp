...
installChilkat()
{
    ...
    ##需要修改cp后的路径，版本不同路径不同
    cd ${extensionName} && cp chilkat_9_5_0.so /usr/local/lib/php/extensions/no-debug-non-zts-20190902
    cd /usr/local/lib/php/extensions/no-debug-non-zts-20190902 && chmod +x chilkat_9_5_0.so
